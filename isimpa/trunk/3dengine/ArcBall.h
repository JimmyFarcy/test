...
/**															**/
/**	  Please note that I can *NOT* support you in any way   **/
/**   if  you want to use this stuff but you are free to    **/
/**	  use it any way you can, make derivative works (in so	**/
/**	  far as the copyright on the code is mine, there are	**/
/**   some chuncks of code that were written by other		**/
/**	  people).												**/
/**															**/
/**   History:                                              **/
