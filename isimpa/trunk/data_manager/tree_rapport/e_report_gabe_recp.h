...
#ifndef __ELEMENT_GABE_RECP__
#define __ELEMENT_GABE_RECP__



/** \file e_report_gabe_recp.h
 *  \brief Classe post traitement de résultats de récépteurs ponctuels
 */

/**
 *  \brief Classe post traitement de résultats de récépteurs ponctuels
 */
class E_Report_Gabe_Recp: public E_Report_Gabe
{
public:
	/**
	 ...
	 */
	E_Report_Gabe_Recp(Element* parent,wxString Nom,wxString Path);
	 ...
	 */
	E_Report_Gabe_Recp(Element* parent,wxXmlNode* nodeElement);
