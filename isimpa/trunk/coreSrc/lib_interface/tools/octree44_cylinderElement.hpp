...
/**
 * @file octree44_cylinderElement.hpp
 *
 * @brief Implémentation de l'élément cylindre
 */

#ifndef __OCTREE44_CYLINDERELEMENT_H__
#define __OCTREE44_CYLINDERELEMENT_H__
...
namespace octreeTool
{
	 ...
	 */
	class cylinderElement : public spaceElement
	{
		public:
			cylinderElement(const coordPrecision positionA[3],const coordPrecision positionB[3],const float& _radius);
			cylinderElement( );
			...
			void Set(const coordPrecision positionA[3],const coordPrecision positionB[3],const float& radius);
		protected:
			/**
