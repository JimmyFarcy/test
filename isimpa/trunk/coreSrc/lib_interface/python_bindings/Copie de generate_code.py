...
if __name__ == '__main__':
    ...
    mb = module_builder.module_builder_t( files=[
                                                     os.path.abspath('../input_output/bin.h'),
                                                     os.path.abspath('../input_output/importExportMaillage/mbin.h'),
                                                     os.path.abspath('../input_output/gabe/stdgabe.h'),
                                                     os.path.abspath('../input_output/progressionInfo.h'),
                                                     os.path.abspath('../input_output/exportRecepteurSurf/std_rsbin.hpp'),
                                                     os.path.abspath('../input_output/particles/part_io.hpp'),
                                                     os.path.abspath('../tools/vol_splitter.hpp'),
                                                     os.path.abspath('../tools/surf_merging.hpp'),
                                                     os.path.abspath('../data_manager/data_calculation/calculsPropagation.h')
                                                 ]
                                          , gccxml_path="C:/Program Files/GCC_XML/bin"
                                          , encoding='iso-8859-1'
                                          , indexing_suite_version=2
                                          , include_paths=["../"])
    mb.register_module_dependency("./")
    ...
    VolumesSplitter.mem_fun("GetVolumeInformation").add_transformation( FT.output('volumeXmlId'),FT.output('volume'),FT.output('faceIds'))
